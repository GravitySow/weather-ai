...
COPY rain_probability.py weather_probability_model.py weather_event_report.py train_weather_ai.py train_temperature_intervals.py tune_event_thresholds.py /app/
COPY evaluation.json model_manifest.json weather_features.joblib weather_regression_features.joblib weather_thresholds.joblib weather_onset_thresholds.joblib /app/
COPY weather_xgb_model_5m.joblib weather_xgb_model_10m.joblib weather_xgb_model_30m.joblib /app/
COPY weather_rf_onset_model_5m.joblib weather_rf_onset_model_10m.joblib weather_rf_onset_model_30m.joblib /app/
